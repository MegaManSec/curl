...
static CURLcode t3402_setup(struct Curl_easy **easy)
{
...
static void t3402_stop(struct Curl_easy *easy)
{
...
static CURLcode test_unit3402(const char *arg)
{
  ...
  UNITTEST_BEGIN(t3402_setup(&easy))
