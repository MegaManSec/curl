...
static CURLcode t1688_setup(struct Curl_easy **easy)
{
...
static void t1688_stop(struct Curl_easy *easy)
{
...
static CURLcode test_unit1688(const char *arg)
{
  ...
  UNITTEST_BEGIN(t1688_setup(&easy))
