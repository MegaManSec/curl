...
connection. A transfer with this option enabled does not reuse a connection
that was set up without it (and vice versa), so libcurl opens a new
connection instead of silently omitting or duplicating the header.
